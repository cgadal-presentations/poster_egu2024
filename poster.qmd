...
<h2 style="margin-top:10px"> {{< fa book >}} - Introduction </h2>

::: {layout="[2.5, 0.01, 2]" layout-valign="center"}
...
{{< fa question-circle >}} &nbsp; suspended particles above riverbed {{< fa arrow-right >}} where does the fine particles go? 
...
- analogue lab. experiments:
  - column or channel
  - porous matrix is optically opaque (sand, glass beads)

:::{.boxed-orange .centered}

<ul class="fa-ul">
  <li><span class="fa-li"><i class="fa fa-arrow-right"></i></span>isolated time/space vertical profiles.</li>
  <li><span class="fa-li"><i class="fa fa-question-circle"></i></span>How to measure the spatio-temporal dynamics?</li>
</ul>
...
:::: {style="max-width: 50%; margin: 35px auto; border-bottom: 3px solid #71767a;"}
::::
...
C. Gadal (cyril.gadal@imft.fr), M. Mercier and L. Lacaze. Institut de Mécanique des Fluides de Toulouse (IMFT), France
:::
...
- infiltration velocity starts at $w_{\rm s}$, then increases in $t^{3/2}$
...
![Steady injection of a suspension building a deposit over time.](poster_files/src/images/PXL_20230725_140126323.jpg){width=100% fig-align="center"}
